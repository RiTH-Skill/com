...
public class frmNotifications extends JFrame{
    ...
    lblVenueManagement = new JLabel("Management Notifications\r\n");
    lblVenueManagement.setFont(new Font("Arial Rounded MT Bold", Font.BOLD, 20));
    lblVenueManagement.setBounds(522, 10, 306, 56);
    ...
    btnSenf = new JButton("Send");
    btnSenf.addActionListener(new ActionListener() {
    	public void actionPerformed(ActionEvent e) {
    		...
    		try {
    			connectionWithDatabase.connection();
				java.sql.Statement s = connectionWithDatabase.getCON().createStatement();
				String sql="INSERT INTO `eventsmanagementsystem`.`tbl_notificationmessage` (`Notification Massage`, `SentOn`) VALUES ('"+message+"', '"+now+"')";
				s.execute(sql);     
    ...
    btnSenf.setFont(new Font("Arial", Font.BOLD, 20));
    btnSenf.setBackground(Color.GREEN);
    btnSenf.setBounds(156, 520, 169, 40);
    getContentPane().add(btnSenf);
